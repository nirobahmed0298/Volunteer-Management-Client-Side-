        ...
        <div className='md:w-7/12 mx-auto border-emerald-300 border my-10'>
            <form onSubmit={handleLogin} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="password" placeholder="password" name='password' className="input rounded-none input-bordered" required />
                    <label className="label">
                ...
                <div className="form-control mt-6">
                    ...
                    <p className='text-center mt-6'>Don't have an account?please <Link to='/signup' className='text-green-500 underline'>Register</Link></p>
                </div>
            </form>
        </div>
    );
